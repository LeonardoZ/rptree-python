...
def main():
    ...
    if not root_dir.is_dir():
        print("The specified root dir doesn't exist")
        sys.exit()
...
def parse_cmd_line_arguments():
    ...
    parser.add_argument("root_dir", metavar="ROOT_DIR", nargs="?",
     default=".", help="Generate a full directory tree starting at ROOT_DIR")
